...
exports.NewScanPolicySettingModelToJSON = exports.NewScanPolicySettingModelFromJSONTyped = exports.NewScanPolicySettingModelFromJSON = exports.instanceOfNewScanPolicySettingModel = void 0;
 ...
 */
function instanceOfNewScanPolicySettingModel(value) {
    let isInstance = true;
...
exports.instanceOfNewScanPolicySettingModel = instanceOfNewScanPolicySettingModel;
function NewScanPolicySettingModelFromJSON(json) {
    return NewScanPolicySettingModelFromJSONTyped(json, false);
}
exports.NewScanPolicySettingModelFromJSON = NewScanPolicySettingModelFromJSON;
function NewScanPolicySettingModelFromJSONTyped(json, ignoreDiscriminator) {
...
exports.NewScanPolicySettingModelFromJSONTyped = NewScanPolicySettingModelFromJSONTyped;
function NewScanPolicySettingModelToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.NewScanPolicySettingModelToJSON = NewScanPolicySettingModelToJSON;
