 ...
 */
export function instanceOfNewScanPolicySettingModel(value) {
    let isInstance = true;
...
export function NewScanPolicySettingModelFromJSON(json) {
    return NewScanPolicySettingModelFromJSONTyped(json, false);
}
export function NewScanPolicySettingModelFromJSONTyped(json, ignoreDiscriminator) {
...
export function NewScanPolicySettingModelToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
