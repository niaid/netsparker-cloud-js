 ...
 */
export function instanceOfPivotalTrackerIntegrationInfoModel(value) {
    let isInstance = true;
...
export function PivotalTrackerIntegrationInfoModelFromJSON(json) {
    return PivotalTrackerIntegrationInfoModelFromJSONTyped(json, false);
}
export function PivotalTrackerIntegrationInfoModelFromJSONTyped(json, ignoreDiscriminator) {
...
export function PivotalTrackerIntegrationInfoModelToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
