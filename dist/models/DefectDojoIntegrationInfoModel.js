 ...
 */
export function instanceOfDefectDojoIntegrationInfoModel(value) {
    let isInstance = true;
...
export function DefectDojoIntegrationInfoModelFromJSON(json) {
    return DefectDojoIntegrationInfoModelFromJSONTyped(json, false);
}
export function DefectDojoIntegrationInfoModelFromJSONTyped(json, ignoreDiscriminator) {
...
export function DefectDojoIntegrationInfoModelToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
