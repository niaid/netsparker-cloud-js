...
import { IssueSummaryApiModelFromJSON, IssueSummaryApiModelToJSON, } from './IssueSummaryApiModel';
/**
 * Check if a given object implements the IssueSummaryApiResult interface.
 */
export function instanceOfIssueSummaryApiResult(value) {
    let isInstance = true;
    return isInstance;
}
export function IssueSummaryApiResultFromJSON(json) {
    return IssueSummaryApiResultFromJSONTyped(json, false);
}
export function IssueSummaryApiResultFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'list': !exists(json, 'List') ? undefined : (json['List'].map(IssueSummaryApiModelFromJSON)),
...
export function IssueSummaryApiResultToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'List': value.list === undefined ? undefined : (value.list.map(IssueSummaryApiModelToJSON)),
