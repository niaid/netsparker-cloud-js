...
import { DiscoveryApiModelFromJSON, DiscoveryApiModelToJSON, } from './DiscoveryApiModel';
/**
 * Check if a given object implements the DiscoveryServiceListApiResult interface.
 */
export function instanceOfDiscoveryServiceListApiResult(value) {
    let isInstance = true;
    return isInstance;
}
export function DiscoveryServiceListApiResultFromJSON(json) {
    return DiscoveryServiceListApiResultFromJSONTyped(json, false);
}
export function DiscoveryServiceListApiResultFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'list': !exists(json, 'List') ? undefined : (json['List'].map(DiscoveryApiModelFromJSON)),
...
export function DiscoveryServiceListApiResultToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'List': value.list === undefined ? undefined : (value.list.map(DiscoveryApiModelToJSON)),
