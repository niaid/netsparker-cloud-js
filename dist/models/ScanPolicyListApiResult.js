...
import { ScanPolicySettingItemApiModelFromJSON, ScanPolicySettingItemApiModelToJSON, } from './ScanPolicySettingItemApiModel';
/**
 * Check if a given object implements the ScanPolicyListApiResult interface.
 */
export function instanceOfScanPolicyListApiResult(value) {
    let isInstance = true;
    return isInstance;
}
export function ScanPolicyListApiResultFromJSON(json) {
    return ScanPolicyListApiResultFromJSONTyped(json, false);
}
export function ScanPolicyListApiResultFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'list': !exists(json, 'List') ? undefined : (json['List'].map(ScanPolicySettingItemApiModelFromJSON)),
...
export function ScanPolicyListApiResultToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'List': value.list === undefined ? undefined : (value.list.map(ScanPolicySettingItemApiModelToJSON)),
