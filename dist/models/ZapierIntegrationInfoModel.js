 ...
 */
export function instanceOfZapierIntegrationInfoModel(value) {
    let isInstance = true;
    isInstance = isInstance && "webhookUrl" in value;
    isInstance = isInstance && "titleFormat" in value;
    return isInstance;
}
export function ZapierIntegrationInfoModelFromJSON(json) {
    return ZapierIntegrationInfoModelFromJSONTyped(json, false);
}
export function ZapierIntegrationInfoModelFromJSONTyped(json, ignoreDiscriminator) {
...
export function ZapierIntegrationInfoModelToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
