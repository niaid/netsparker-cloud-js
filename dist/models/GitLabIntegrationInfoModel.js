 ...
 */
export function instanceOfGitLabIntegrationInfoModel(value) {
    let isInstance = true;
...
export function GitLabIntegrationInfoModelFromJSON(json) {
    return GitLabIntegrationInfoModelFromJSONTyped(json, false);
}
export function GitLabIntegrationInfoModelFromJSONTyped(json, ignoreDiscriminator) {
...
export function GitLabIntegrationInfoModelToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
