 ...
 */
export function instanceOfUpdateScheduledScanApiModel(value) {
    let isInstance = true;
...
export function UpdateScheduledScanApiModelFromJSON(json) {
    return UpdateScheduledScanApiModelFromJSONTyped(json, false);
}
export function UpdateScheduledScanApiModelFromJSONTyped(json, ignoreDiscriminator) {
...
export function UpdateScheduledScanApiModelToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
