 ...
 */
export declare function instanceOfTechnologyApiModel(value: object): boolean;
export declare function TechnologyApiModelFromJSON(json: any): TechnologyApiModel;
export declare function TechnologyApiModelFromJSONTyped(json: any, ignoreDiscriminator: boolean): TechnologyApiModel;
export declare function TechnologyApiModelToJSON(value?: TechnologyApiModel | null): any;
