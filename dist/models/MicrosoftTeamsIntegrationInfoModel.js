 ...
 */
export function instanceOfMicrosoftTeamsIntegrationInfoModel(value) {
    let isInstance = true;
    isInstance = isInstance && "webhookUrl" in value;
    isInstance = isInstance && "titleFormat" in value;
    return isInstance;
}
export function MicrosoftTeamsIntegrationInfoModelFromJSON(json) {
    return MicrosoftTeamsIntegrationInfoModelFromJSONTyped(json, false);
}
export function MicrosoftTeamsIntegrationInfoModelFromJSONTyped(json, ignoreDiscriminator) {
...
export function MicrosoftTeamsIntegrationInfoModelToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
