...
import { SaveScanProfileApiModelFromJSON, SaveScanProfileApiModelToJSON, } from './SaveScanProfileApiModel';
/**
 * Check if a given object implements the ScanProfilesListApiResult interface.
 */
export function instanceOfScanProfilesListApiResult(value) {
    let isInstance = true;
    return isInstance;
}
export function ScanProfilesListApiResultFromJSON(json) {
    return ScanProfilesListApiResultFromJSONTyped(json, false);
}
export function ScanProfilesListApiResultFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'list': !exists(json, 'List') ? undefined : (json['List'].map(SaveScanProfileApiModelFromJSON)),
...
export function ScanProfilesListApiResultToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'List': value.list === undefined ? undefined : (value.list.map(SaveScanProfileApiModelToJSON)),
