 ...
 */
export function instanceOfSaveScanProfileApiModel(value) {
    let isInstance = true;
    isInstance = isInstance && "profileName" in value;
    return isInstance;
}
export function SaveScanProfileApiModelFromJSON(json) {
    return SaveScanProfileApiModelFromJSONTyped(json, false);
}
export function SaveScanProfileApiModelFromJSONTyped(json, ignoreDiscriminator) {
...
export function SaveScanProfileApiModelToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
