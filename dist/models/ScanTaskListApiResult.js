...
import { ScanTaskModelFromJSON, ScanTaskModelToJSON, } from './ScanTaskModel';
/**
 * Check if a given object implements the ScanTaskListApiResult interface.
 */
export function instanceOfScanTaskListApiResult(value) {
    let isInstance = true;
    return isInstance;
}
export function ScanTaskListApiResultFromJSON(json) {
    return ScanTaskListApiResultFromJSONTyped(json, false);
}
export function ScanTaskListApiResultFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'list': !exists(json, 'List') ? undefined : (json['List'].map(ScanTaskModelFromJSON)),
...
export function ScanTaskListApiResultToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'List': value.list === undefined ? undefined : (value.list.map(ScanTaskModelToJSON)),
