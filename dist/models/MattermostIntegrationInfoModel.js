 ...
 */
export function instanceOfMattermostIntegrationInfoModel(value) {
    let isInstance = true;
    isInstance = isInstance && "incomingWebhookUrl" in value;
    isInstance = isInstance && "titleFormat" in value;
    return isInstance;
}
export function MattermostIntegrationInfoModelFromJSON(json) {
    return MattermostIntegrationInfoModelFromJSONTyped(json, false);
}
export function MattermostIntegrationInfoModelFromJSONTyped(json, ignoreDiscriminator) {
...
export function MattermostIntegrationInfoModelToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
