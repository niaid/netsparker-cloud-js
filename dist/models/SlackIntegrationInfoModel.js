 ...
 */
export function instanceOfSlackIntegrationInfoModel(value) {
    let isInstance = true;
    isInstance = isInstance && "incomingWebhookUrl" in value;
    isInstance = isInstance && "titleFormat" in value;
    return isInstance;
}
export function SlackIntegrationInfoModelFromJSON(json) {
    return SlackIntegrationInfoModelFromJSONTyped(json, false);
}
export function SlackIntegrationInfoModelFromJSONTyped(json, ignoreDiscriminator) {
...
export function SlackIntegrationInfoModelToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
