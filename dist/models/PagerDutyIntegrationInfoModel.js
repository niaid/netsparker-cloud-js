 ...
 */
export function instanceOfPagerDutyIntegrationInfoModel(value) {
    let isInstance = true;
...
export function PagerDutyIntegrationInfoModelFromJSON(json) {
    return PagerDutyIntegrationInfoModelFromJSONTyped(json, false);
}
export function PagerDutyIntegrationInfoModelFromJSONTyped(json, ignoreDiscriminator) {
...
export function PagerDutyIntegrationInfoModelToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
