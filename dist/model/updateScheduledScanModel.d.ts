...
*/
export declare class UpdateScheduledScanModel {
    /**
...
export declare namespace UpdateScheduledScanModel {
    enum ScanTypeEnum {
        Full,
        Retest,
        Incremental
    ...
    enum CustomScriptTemplateTypeEnum {
        Default,
        SimpleLoginForm,
        SimpleLoginFormQuery,
        SimpleLoginFormDelay
    }
    enum CreateTypeEnum {
        Website,
        WebsiteGroup
