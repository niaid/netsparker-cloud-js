...
export class ScansApi {
    ...
    public async scansReport (format: 'Xml' | 'Csv' | 'Pdf' | 'Html' | 'Txt' | 'Json', id: string, type: 'Crawled' | 'Scanned' | 'Vulnerabilities' | 'ScanDetail' | 'ModSecurityWafRules' | 'OwaspTopTen2013' | 'HIPAACompliance' | 'PCICompliance' | 'KnowledgeBase' | 'ExecutiveSummary' | 'FullScanDetail' | 'OwaspTopTen2017' | 'CustomReport' | 'Iso27001Compliance' | 'F5BigIpAsmWafRules' | 'WASC' | 'SansTop25' | 'Asvs40' | 'Nistsp80053' | 'DisaStig' | 'OwaspApiTop10' | 'OwaspTopTen2021', contentFormat?: 'Html' | 'Markdown', excludeResponseData?: boolean, onlyConfirmedIssues?: boolean, onlyUnconfirmedIssues?: boolean, excludeAddressedIssues?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        ...
        if (type !== undefined) {
            localVarQueryParameters['type'] = ObjectSerializer.serialize(type, "'Crawled' | 'Scanned' | 'Vulnerabilities' | 'ScanDetail' | 'ModSecurityWafRules' | 'OwaspTopTen2013' | 'HIPAACompliance' | 'PCICompliance' | 'KnowledgeBase' | 'ExecutiveSummary' | 'FullScanDetail' | 'OwaspTopTen2017' | 'CustomReport' | 'Iso27001Compliance' | 'F5BigIpAsmWafRules' | 'WASC' | 'SansTop25' | 'Asvs40' | 'Nistsp80053' | 'DisaStig' | 'OwaspApiTop10' | 'OwaspTopTen2021'");
        }
    ...
    /**
     * 
     * @summary Removes and deletes a scheduled scan.
     * @param id The identifier of scan.
     */
