...
export class WebsitesApi {
     ...
     */
    public async websitesGet (query: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: WebsiteApiModel;  }> {
     ...
     */
    public async websitesGet_1 (id: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: WebsiteApiModel;  }> {
