...
export enum ScanProfilesApiApiKeys {
}

export class ScanProfilesApi {
    ...
    public setApiKey(key: ScanProfilesApiApiKeys, value: string) {
        (this.authentications as any)[ScanProfilesApiApiKeys[key]].apiKey = value;
    }
     ...
     */
    public async scanProfilesDelete (profileId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: string;  }> {
        ...
        if (profileId === null || profileId === undefined) {
            throw new Error('Required parameter profileId was null or undefined when calling scanProfilesDelete.');
        }
     ...
     */
    public async scanProfilesGetById (id: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SaveScanProfileApiModel;  }> {
        const localVarPath = this.basePath + '/api/1.0/scanprofiles/get/{id}'
        ...
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling scanProfilesGetById.');
        }
     ...
     */
    public async scanProfilesGetByName (name: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SaveScanProfileApiModel;  }> {
        ...
        if (name === null || name === undefined) {
            throw new Error('Required parameter name was null or undefined when calling scanProfilesGetByName.');
        }
     ...
     */
    public async scanProfilesNew (model: SaveScanProfileApiModel, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SaveScanProfileApiModel;  }> {
        ...
        if (model === null || model === undefined) {
            throw new Error('Required parameter model was null or undefined when calling scanProfilesNew.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(model, "SaveScanProfileApiModel")
        };
     ...
     */
    public async scanProfilesUpdate (model: SaveScanProfileApiModel, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SaveScanProfileApiModel;  }> {
        ...
        // verify required parameter 'model' is not null or undefined
        if (model === null || model === undefined) {
            throw new Error('Required parameter model was null or undefined when calling scanProfilesUpdate.');
        }
