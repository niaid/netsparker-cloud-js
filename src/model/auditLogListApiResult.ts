...
/**
* Represents a model for carrying out a paged list of {Netsparker.Cloud.Infrastructure.Models.AuditLogViewModel}
*/
export class AuditLogListApiResult {
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return AuditLogListApiResult.attributeTypeMap;
    }
}
