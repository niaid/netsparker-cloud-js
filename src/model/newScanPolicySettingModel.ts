...
*/
export class NewScanPolicySettingModel {
    /**
    ...
    */
    ...
    /**
    * Gets or sets a value indicating whether this scan policy is shared.  If you set this value to true, you have to fill in the SelectedGroups value.
    */
    'isShared'?: boolean;
