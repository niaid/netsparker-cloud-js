 ...
 */
export function instanceOfIssueApiModel(value: object): boolean {
    return true;
}

export function IssueApiModelFromJSON(json: any): IssueApiModel {
    return IssueApiModelFromJSONTyped(json, false);
}

export function IssueApiModelFromJSONTyped(json: any, ignoreDiscriminator: boolean): IssueApiModel {
    if (json == null) {
        return json;
    }
    return {
...
export function IssueApiModelToJSON(value?: Omit<IssueApiModel, 'Parameters'|'CustomFields'|'Cvss31VectorString'|'Cvss40VectorString'|'CvssVector'|'Cvss31Vector'|'Cvss40Vector'|'VersionIssues'> | null): any {
    if (value == null) {
        return value;
    }
    return {
